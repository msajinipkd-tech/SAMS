...
<div class="row">
    <div class="col-md-8 mx-auto">
        <a href="<?php echo URLROOT; ?>/pesticides" class="btn btn-primary">
            < Back</a>
                <h2>Edit Pesticide</h2>
                <form action="<?php echo URLROOT; ?>/pesticides/edit/<?php echo $data['id']; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="usage_instructions"
                            class="form-control"><?php echo $data['usage_instructions']; ?></textarea>
                    </div>
